...
export default function Navbar() {
  ...
  "
    ...
    "
          >
            <span className="whitespace-nowrap">GST No. 07AAGCJ7313Q1Z2</span>
          ...
          <div className="min-h-[75px] flex items-center justify-between px-2 sm:px-4 md:px-10 gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-4 lg:gap-12 flex-shrink-0">
              ...
              <div className="hidden lg:flex items-center gap-12 text-[17px]">
                ...
                <Link href="/shop" className="font-medium text-[#071B31]">
                  Shop
                </Link>

                <Link href="/about" className="font-medium text-[#071B31]">
                  About
                </Link>

                <Link href="/blog" className="font-medium text-[#071B31]">
                  Articles
                </Link>
              </div>
            </div>
        ...
        <div className="h-[54px] sm:h-[60px] md:h-[65px] flex items-center px-2 sm:px-4 bg-[#FAF7F2] border-b border-[#d9d0c7] overflow-hidden">
          ...
          >
            {[...categories, ...categories].map((cat, index) => (
              <SwiperSlide key={`${cat._id}-${index}`} className="!w-auto">
                <Link
        ...
        >
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            >
              ...
              <p className="text-[16px] text-[#2f3b52]">Cart</p>
            </div>
          </div>
