      ...
      <section className="max-w-5xl mx-auto px-4 md:px-8 py-10 text-gray-700">
        ...
        <div className="mt-10">
          ...
          <ul className="space-y-1 text-sm sm md:text-xl leading-relaxed list-disc pl-5">
            <li>
              <strong>Company:</strong> JL Industries, India
            </li>
            <li>
            ...
            <li>
              <strong>Device:</strong> Any device such as computer or mobile
            </li>
            <li>
              <strong>You:</strong> The user accessing the Service
            </li>
          </ul>
        </div>
        ...
        <div className="mt-10">
          ...
          <h3 className="font-medium  md:text-xl mt-4 mb-2">
        ...
        {/* Retention */}
        <div className="mt-10">
          <h2 className="text-xl font-semibold mb-3">Retention of Your Data</h2>
        ...
        {/* Security */}
        <div className="mt-10">
          <h2 className="text-xl font-semibold mb-3">Security of Your Data</h2>

          <p className="text-sm md:text-xl leading-relaxed">
            We use commercially acceptable means to protect your data, but no
